# GM_EXPENSES_PERMANENT_EXPEDIENTE_SEQUENCE_V65_25 §38 - dirty worktree classification (2026-09-17)
...
## Gystigo - feature/gm-fleets-minimum-vehicle-master-01 at 0293ff4 (16 paths)
...
| _M | platform_os/studio/channel/browser/shell/fixtures/ExpenseCaseCardsFixture.jsx | STEP_25 - permanent expediente sequence (V65) |
| _M | platform_os/studio/channel/browser/shell/fixtures/ExpenseCaseDetailFixture.jsx | STEP_25 - permanent expediente sequence (V65) |
...
| _M | platform_os/studio/verification/contracts/browser/AdvanceRenditionFlow.contract.mjs | STEP_25 - permanent expediente sequence (V65) |
| _M | platform_os/studio/verification/contracts/browser/ExpenseCaseCard.contract.mjs | STEP_25 - permanent expediente sequence (V65) |
...
## Fabric - main at 018ea84 (17 paths)
